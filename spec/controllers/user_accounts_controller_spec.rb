...
RSpec.describe UserAccountsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all user_accounts as @user_accounts" do
  ...
  describe "GET #show" do
    it "assigns the requested user_account as @user_account" do
      user_account = UserAccount.create! valid_attributes
      get :show, {:id => user_account.to_param}, valid_session
      expect(assigns(:user_account)).to eq(user_account)
    end
  end

  describe "GET #new" do
    it "assigns a new user_account as @user_account" do
      get :new, {}, valid_session
      expect(assigns(:user_account)).to be_a_new(UserAccount)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created user_account as @user_account" do
        post :create, {:user_account => valid_attributes}, valid_session
        expect(assigns(:user_account)).to be_a(UserAccount)
        expect(assigns(:user_account)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved user_account as @user_account" do
        post :create, {:user_account => invalid_attributes}, valid_session
        expect(assigns(:user_account)).to be_a_new(UserAccount)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested user_account" do
        user_account = UserAccount.create! valid_attributes
        put :update, {:id => user_account.to_param, :user_account => new_attributes}, valid_session
        user_account.reload
      ...
      it "redirects to the user_account" do
        user_account = UserAccount.create! valid_attributes
        put :update, {:id => user_account.to_param, :user_account => valid_attributes}, valid_session
        expect(response).to redirect_to(user_account)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the user_account as @user_account" do
        user_account = UserAccount.create! valid_attributes
        put :update, {:id => user_account.to_param, :user_account => invalid_attributes}, valid_session
        expect(assigns(:user_account)).to eq(user_account)
      end
